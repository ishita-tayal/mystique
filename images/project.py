...
def welcomescreen():
    ...
    clear_frame()
    canvasdefinition()
    welcomescreenimg = PhotoImage(file = f"welcomescreen.png")
    background = canvas.create_image(494.0, 300.0,image=welcomescreenimg)
    custbtn = PhotoImage(file = f"custbtn.png")
    ...
    exebtn = PhotoImage(file = f"executivebtn.png")
...
def loginscreen(B):
    ...
    canvasdefinition()
    if B==0: 
        loginscreenimg=PhotoImage(file=f"loginscreenusernotreg.png")
    elif B==2:
        loginscreenimg=PhotoImage(file=f"loginscreennotmatch.png")
    else:
        loginscreenimg = PhotoImage(file = f"loginscreen.png")
    ...
    loginbtn = PhotoImage(file = f"loginbtn.png")
    ...
    loginsignupbtn = PhotoImage(file = f"loginsignupbtn.png")
    ...
    backbtn= PhotoImage(file = f"backbtn.png")
    ...
    def showpassword():
        ...
        loginpwentry['show']=""
        showpw.place_forget()
        hidepwbtn= PhotoImage(file = f"hidepwbtn.png")
    ...
    showpwbtn= PhotoImage(file = f"showpwbtn.png")
...
def signupscreen():
    ...
    closewindows()
    canvasdefinition()
    signupscreenimg = PhotoImage(file = f"signupscreen.png")
    ...
    def showpassword1():
        ...
        hidepwbtn1= PhotoImage(file = f"hidepwsmall1.png")
    ...
    showpwbtn1= PhotoImage(file = f"showpwsmall1.png")
    ...
    def showpassword2():
        ...
        hidepwbtn2= PhotoImage(file = f"hidepwsmall.png")
    ...
    #button to show password
    showpwbtn2= PhotoImage(file = f"showpwsmall.png")
    ...
    signupbtn = PhotoImage(file = f"signupbtn.png")
...
def homepage():
    ...
    homepagescreen=PhotoImage(file=f"homepagescreen.png")
    background = canvas.create_image(500.0, 300.0,image=homepagescreen)

    Ordersbtn= PhotoImage(file = f"Ordersbtn.png")
    ...
    Accountbtn= PhotoImage(file = f"Accountbtn.png")
    ...
    Privacypolicybtn= PhotoImage(file = f"Privacypolicybtn.png")
    ...
    Categoriesbtn= PhotoImage(file = f"Categoriesbtn.png")
    ...
    Cartbtn= PhotoImage(file = f"Cartbtn.png")
    ...
    wbackbtn = PhotoImage(file = f"homepageback.png")
    ...
    banner1 = ImageTk.PhotoImage(Image.open("homepagebanner1.png"))
    banner2 = ImageTk.PhotoImage(Image.open("homepagebanner2.png"))
    banner3 = ImageTk.PhotoImage(Image.open("homepagebanner3.png"))
    banner4 = ImageTk.PhotoImage(Image.open("homepagebanner4.png"))
    banner5 = ImageTk.PhotoImage(Image.open("homepagebanner5.png"))
...
def privpolscreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#d8dff9")
    privacypolicybg=PhotoImage(file=f"privacypolicyscreen.png")
    background = canvas.create_image(500.0, 300.0,image=privacypolicybg)
    backbtn= PhotoImage(file = f"pbackbtn.png")
...
def cartoptionsscreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#d8dff9")
    cartoptionsbg=PhotoImage(file=f"cartoptionsscreen.png")
    background = canvas.create_image(500.0, 300.0,image=cartoptionsbg)

    viewcartbtn= PhotoImage(file = f"viewcartbtn.png")
    ...
    checkoutbtn= PhotoImage(file = f"checkoutbtn.png")
    ...
    wbackbtn = PhotoImage(file = f"bluebackbtn.png")
...
def checkoutscreen():
    ...
    if codetails[0][0]==None:
        ...
        checkoutscreenbg=PhotoImage(file=f"checkoutscreen.png")
        ...
        placeorderbtn= PhotoImage(file = f"placeorderbtn.png")
...
def seecart():
    ...
    if len(records)==0:
        ...
        buttonlist2=[]
        rowno=2
        removebtn = ImageTk.PhotoImage(Image.open("removeicon.png"))
...
def searchscreen():
    ...
    closewindows()
    canvasdefinition()
    searchscreenimg = PhotoImage(file = f"searchscreen.png")
    background = canvas.create_image( 500.0, 300.0, image=searchscreenimg)
    categorymenbtn= PhotoImage(file = f"categorymenbtn.png")
    ...
    categorywomenbtn= PhotoImage(file = f"categorywomenbtn.png")
    ...
    categorykidsbtn= PhotoImage(file = f"categorykidsbtn.png")
    ...
    categoryaccbtn= PhotoImage(file = f"categoryaccbtn.png")
    ...
    categoryelectbtn= PhotoImage(file = f"categoryelectbtn.png")
    ...
    categorybeautybtn= PhotoImage(file = f"categorybeautybtn.png")
    ...
    categoryhnlbtn= PhotoImage(file = f"categoryhnlbtn.png")
    ...
    categoryluxebtn= PhotoImage(file = f"categoryluxebtn.png")
    ...
    mystiquebtn= PhotoImage(file = f"mystiquebtn.png")
...
def mencategoryscreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#d8dff9")
    menscreen=PhotoImage(file=f"menscreen.png")
    background = canvas.create_image(500.0, 300.0,image=menscreen)

    tshirtsbtn = PhotoImage(file = f"tshirtsbtn.png")
    ...
    shirtsbtn = PhotoImage(file = f"shirtsbtn.png")
    ...
    mjeansbtn = PhotoImage(file = f"mjeansbtn.png")
    ...
    trousersandpantsbtn = PhotoImage(file = f"trousersandpantsbtn.png")
    ...
    traditionalwearbtn = PhotoImage(file = f"traditionalwearbtn.png")
    ...
    mshoesbtn = PhotoImage(file = f"mshoesbtn.png")
    ...
    maccessoriesbtn = PhotoImage(file = f"maccessoriesbtn.png")
    ...
    wbackbtn = PhotoImage(file = f"wbackbtn.png")
    ...
    banner1 = ImageTk.PhotoImage(Image.open("menscreenbanner1.png"))
    banner2 = ImageTk.PhotoImage(Image.open("menscreenbanner2.png"))
    banner3 = ImageTk.PhotoImage(Image.open("menscreenbanner3.png"))
    banner4 = ImageTk.PhotoImage(Image.open("menscreenbanner4.png"))
    banner5 = ImageTk.PhotoImage(Image.open("menscreenbanner5.png"))
...
def mtshirts():
    ...
    mtshirtsbg=PhotoImage(file=f"mtshirts.png")
    background = canvas.create_image(500.0, 300.0,image=mtshirtsbg)
    cartbtn=PhotoImage(file=f"cartbtn1.png")
    def size(i):
        global clicked
    ...
    wbackbtn = PhotoImage(file = f"backwhitebtn.png")
...
def mshirts():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    mshirtsbg=PhotoImage(file=f"mshirts.png")
...
def mjeansscreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    mjeansbg=PhotoImage(file=f"mjeans.png")
...
def mpants():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    mpantsbg=PhotoImage(file=f"mpants.png")
...
def mtraditionalwear():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    mtraditionalwearbg=PhotoImage(file=f"mtraditionalwear.png")
...
def mshoesscreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    mshoesbg=PhotoImage(file=f"mshoes.png")
...
def maccessoriesscreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    maccessoriesbg=PhotoImage(file=f"maccessories.png")
    background = canvas.create_image(500.0, 300.0,image=maccessoriesbg)
    cartbtn=PhotoImage(file=f"cartbtn2.png")
    def addtocart(i):
        global cart
...
def womencategoryscreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#d8dff9")
    womenscreen=PhotoImage(file=f"womenscreen.png")
    background = canvas.create_image(500.0, 300.0,image=womenscreen)

    dressesandjumpsuitsbtn = PhotoImage(file = f"dressesandjumpsuitsbtn.png")
    ...
    topsandteesbtn = PhotoImage(file = f"topsandteesbtn.png")
    ...
    traditionalsbtn = PhotoImage(file = f"traditionalsbtn.png")
    ...
    trouserbtn = PhotoImage(file = f"trouserbtn.png")
    ...
    shoesbtn = PhotoImage(file = f"shoesbtn.png")
    ...
    heelsandflatsbtn = PhotoImage(file = f"heelsandflatsbtn.png")
    ...
    sleepwearbtn = PhotoImage(file = f"sleepwearbtn.png")
    ...
    banner1 = ImageTk.PhotoImage(Image.open("womenscreenbanner1.png"))
    banner2 = ImageTk.PhotoImage(Image.open("womenscreenbanner2.png"))
    banner3 = ImageTk.PhotoImage(Image.open("womenscreenbanner3.png"))
    banner4 = ImageTk.PhotoImage(Image.open("womenscreenbanner4.png"))
    banner5 = ImageTk.PhotoImage(Image.open("womenscreenbanner5.png"))
...
def wdresses():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    wdressbg=PhotoImage(file=f"wdresses.png")
...
def wtops():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    wtopsbg=PhotoImage(file=f"wtops.png")
...
def wtraditionals():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    wtraditionalsbg=PhotoImage(file=f"wtraditionals.png")
...
def wbottomwear():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    wbottomwearbg=PhotoImage(file=f"wbottomwear.png")
...
def wshoes():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    wshoesbg=PhotoImage(file=f"wshoes.png")
...
def wheelsandflats():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    wheelsandflatsbg=PhotoImage(file=f"wheelsandflats.png")
...
def wsleepwear():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    wsleepwearbg=PhotoImage(file=f"wsleepwear.png")
...
def kidscategoryscreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#d8dff9")
    kidsscreen=PhotoImage(file=f"kidsscreen.png")
    background = canvas.create_image(500.0, 300.0,image=kidsscreen)

    tshirtsbtn = PhotoImage(file = f"ktshirtsbtn.png")
    ...
    bottomwearbtn = PhotoImage(file = f"kbottomwearbtn.png")
    ...
    traditionalwearbtn = PhotoImage(file = f"ktraditionalwearbtn.png")
    ...
    preteensbtn = PhotoImage(file = f"preteensbtn.png")
    ...
    newbornbtn = PhotoImage(file = f"knewbornbtn.png")
    ...
    footwearbtn = PhotoImage(file = f"kfootwearbtn.png")
    ...
    babycarebtn = PhotoImage(file = f"babycarebtn.png")
    ...
    banner1 = ImageTk.PhotoImage(Image.open("kidsscreenbanner1.png"))
    banner2 = ImageTk.PhotoImage(Image.open("kidsscreenbanner2.png"))
    banner3 = ImageTk.PhotoImage(Image.open("kidsscreenbanner3.png"))
    banner4 = ImageTk.PhotoImage(Image.open("kidsscreenbanner4.png"))
    banner5 = ImageTk.PhotoImage(Image.open("kidsscreenbanner5.png"))
...
def ktshirts():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    ktshirtsbg=PhotoImage(file=f"ktshirts.png")
...
def kbottomwear():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    kbottomwearbg=PhotoImage(file=f"kbottomwear.png")
...
def ktraditionalwear():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    ktraditionalwearbg=PhotoImage(file=f"ktraditionalwear.png")
...
def kpreteens():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    kpreteensbg=PhotoImage(file=f"kpreteens.png")
...
def knewborn():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    knewbornbg=PhotoImage(file=f"knewborn.png")
...
def kfootwear():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    kfootwearbg=PhotoImage(file=f"kfootwear.png")
...
def kbabycare():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    kbabycarebg=PhotoImage(file=f"kbabycare.png")
...
def acccategoryscreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#d8dff9")
    accscreen=PhotoImage(file=f"accscreen.png")
    background = canvas.create_image(500.0, 300.0,image=accscreen)


    earringsbtn = PhotoImage(file = f"earringsbtn.png")
    ...
    jewelrybtn = PhotoImage(file = f"jewelrybtn.png")
    ...
    bagsbtn = PhotoImage(file = f"bagsbtn.png")
    ...
    watchesbtn = PhotoImage(file = f"watchesbtn.png")
    ...
    beltsbtn = PhotoImage(file = f"beltsbtn.png")
    ...
    hairaccbtn = PhotoImage(file = f"hairaccbtn.png")
    ...
    sunglassesbtn = PhotoImage(file = f"sunglassesbtn.png")
    ...
    banner1 = ImageTk.PhotoImage(Image.open("accscreenbanner1.png"))
    banner2 = ImageTk.PhotoImage(Image.open("accscreenbanner2.png"))
    banner3 = ImageTk.PhotoImage(Image.open("accscreenbanner3.png"))
    banner4 = ImageTk.PhotoImage(Image.open("accscreenbanner4.png"))
    banner5 = ImageTk.PhotoImage(Image.open("accscreenbanner5.png"))
...
def aearrings():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    aearringsbg=PhotoImage(file=f"aearrings.png")
    background = canvas.create_image(500.0, 300.0,image=aearringsbg)
    cartbtn=PhotoImage(file=f"mcartbtn.png")
...
def ajewelery():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    ajewelerybg=PhotoImage(file=f"ajewelery.png")
    background = canvas.create_image(500.0, 300.0,image=ajewelerybg)
    cartbtn=PhotoImage(file=f"scartbtn.png")
...
def abags():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    abagsbg=PhotoImage(file=f"abags.png")
...
def awatches():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    awatchesbg=PhotoImage(file=f"awatches.png")
...
def abelts():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    abeltsbg=PhotoImage(file=f"abelts.png")
    background = canvas.create_image(500.0, 300.0,image=abeltsbg)
    cartbtn=PhotoImage(file=f"cartbtn2.png")
    mcartbtn=PhotoImage(file=f"mcartbtn.png")
...
def ahairacc():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    ahairaccbg=PhotoImage(file=f"ahairacc.png")
...
def asunglasses():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    asunglassesbg=PhotoImage(file=f"asunglasses.png")
...
def electronicscategoryscreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#d8dff9")
    electronicsscreen=PhotoImage(file=f"electronicsscreen.png")
    background = canvas.create_image(500.0, 300.0,image=electronicsscreen)

    phonesbtn = PhotoImage(file = f"phonesbtn.png")
    ...
    tabletsbtn = PhotoImage(file = f"tabletsbtn.png")
    ...
    laptopsbtn = PhotoImage(file = f"laptopsbtn.png")
    ...
    tvbtn = PhotoImage(file = f"tvbtn.png")
    ...
    headphonesbtn = PhotoImage(file = f"headphonesbtn.png")
    ...
    speakersbtn = PhotoImage(file = f"speakersbtn.png")
    ...
    accessoriesbtn = PhotoImage(file = f"accessoriesbtn.png")
    ...
    banner1 = ImageTk.PhotoImage(Image.open("electronicsscreenbanner1.png"))
    banner2 = ImageTk.PhotoImage(Image.open("electronicsscreenbanner2.png"))
    banner3 = ImageTk.PhotoImage(Image.open("electronicsscreenbanner3.png"))
    banner4 = ImageTk.PhotoImage(Image.open("electronicsscreenbanner4.png"))
    banner5 = ImageTk.PhotoImage(Image.open("electronicsscreenbanner5.png"))
...
def ephones():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    ephonesbg=PhotoImage(file=f"ephones.png")
...
def etablets():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    etabletsbg=PhotoImage(file=f"etablets.png")
...
def elaptops():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    elaptopsbg=PhotoImage(file=f"elaptops.png")
...
def etv():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    etvbg=PhotoImage(file=f"etv.png")
...
def eheadphones():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    eheadphonesbg=PhotoImage(file=f"eheadphones.png")
...
def espeakers():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    espeakersbg=PhotoImage(file=f"espeakers.png")
...
def eaccessories():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    eaccessoriesbg=PhotoImage(file=f"eaccessories.png")
...
def beautycategoryscreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#d8dff9")
    beautyscreen=PhotoImage(file=f"beautyscreen.png")
    background = canvas.create_image(500.0, 300.0,image=beautyscreen)

    makeupbtn = PhotoImage(file = f"makeupbtn.png")
    ...
    skincarebtn = PhotoImage(file = f"skincarebtn.png")
    ...
    perfumesbtn = PhotoImage(file = f"perfumesbtn.png")
    ...
    haircarebtn = PhotoImage(file = f"haircarebtn.png")
    ...
    appliancesbtn = PhotoImage(file = f"appliancesbtn.png")
    ...
    babbtn = PhotoImage(file = f"babbtn.png")
    ...
    banner1 = ImageTk.PhotoImage(Image.open("beautyscreenbanner1.png"))
    banner2 = ImageTk.PhotoImage(Image.open("beautyscreenbanner2.png"))
    banner3 = ImageTk.PhotoImage(Image.open("beautyscreenbanner3.png"))
    banner4 = ImageTk.PhotoImage(Image.open("beautyscreenbanner4.png"))
    banner5 = ImageTk.PhotoImage(Image.open("beautyscreenbanner5.png"))
...
def bmakeup():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    bmakeupbg=PhotoImage(file=f"bmakeup.png")
...
def bskincare():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    bskincarebg=PhotoImage(file=f"bskincare.png")
...
def bperfumes():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    bperfumesbg=PhotoImage(file=f"bperfumes.png")
...
def bhaircare():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    bhaircarebg=PhotoImage(file=f"bhaircare.png")
...
def bappliances():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    bappliancesbg=PhotoImage(file=f"bappliances.png")
...
def bbathandbody():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    bbathandbodybg=PhotoImage(file=f"bbathandbody.png")
...
def hnlcategoryscreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#d8dff9")
    hnlscreen=PhotoImage(file=f"hnlscreen.png")
    background = canvas.create_image(500.0, 300.0,image=hnlscreen)
    
    bedbtn = PhotoImage(file = f"bedbtn.png")
    ...
    homedecorbtn = PhotoImage(file = f"homedecorbtn.png")
    ...
    lampsbtn = PhotoImage(file = f"lampsbtn.png")
    ...
    flooringbtn = PhotoImage(file = f"flooringbtn.png")
    ...
    kitchenbtn = PhotoImage(file = f"kitchenbtn.png")
    ...
    bathbtn = PhotoImage(file = f"bathbtn.png")
    ...
    cushionsbtn = PhotoImage(file = f"cushionsbtn.png")
    ...
    banner1 = ImageTk.PhotoImage(Image.open("hnlscreenbanner1.png"))
    banner2 = ImageTk.PhotoImage(Image.open("hnlscreenbanner2.png"))
    banner3 = ImageTk.PhotoImage(Image.open("hnlscreenbanner3.png"))
    banner4 = ImageTk.PhotoImage(Image.open("hnlscreenbanner4.png"))
    banner5 = ImageTk.PhotoImage(Image.open("hnlscreenbanner5.png"))
...
def hbedlinenandfurnishing():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    hbedlinenandfurnishingbg=PhotoImage(file=f"hbedlinenandfurnishing.png")
...
def hhomedecor():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    hhomedecorbg=PhotoImage(file=f"hhomedecor.png")
...
def hlampsandlighting():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    hlampsandlightingbg=PhotoImage(file=f"hlampsandlighting.png")
...
def hflooring():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    hflooringbg=PhotoImage(file=f"hflooring.png")
...
def hkitchenandtable():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    hkitchenandtablebg=PhotoImage(file=f"hkitchenandtable.png")
...
def hbath():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    hbathbg=PhotoImage(file=f"hbath.png")
...
def hcushionsandcurtains():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    hcushionsandcurtainsbg=PhotoImage(file=f"hcushionsandcurtains.png")
...
def luxecategoryscreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#d8dff9")
    luxescreen=PhotoImage(file=f"luxescreen.png")
    background = canvas.create_image(500.0, 300.0,image=luxescreen)

    wclothesbtn = PhotoImage(file = f"wclothesbtn.png")
    ...
    waccbtn = PhotoImage(file = f"waccbtn.png")
    ...
    mclothesbtn = PhotoImage(file = f"mclothesbtn.png")
    ...
    maccbtn = PhotoImage(file = f"maccbtn.png")
    ...
    banner1 = ImageTk.PhotoImage(Image.open("luxescreenbanner1.png"))
    banner2 = ImageTk.PhotoImage(Image.open("luxescreenbanner2.png"))
    banner3 = ImageTk.PhotoImage(Image.open("luxescreenbanner3.png"))
...
def lwclothes():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    lwclothesbg=PhotoImage(file=f"lwclothes.png")
...
def lwaccessories():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    lwaccessoriesbg=PhotoImage(file=f"lwaccessories.png")
...
def lmclothes():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    lmclothesbg=PhotoImage(file=f"lmclothes.png")
...
def lmaccessories():
    ...
    canvasdefinition()
    canvas.configure(bg="#ffffff")
    lmaccessoriesbg=PhotoImage(file=f"lmaccessories.png")
...
def profilescreen():
    ...
    canvasdefinition()
    canvas.configure(bg="#d8dff9")
    profilebg=PhotoImage(file=f"profilebg.png")
    ...
    pchangepwdbtn = PhotoImage(file = f"pchangepwdbtn.png")
    ...
    pchangeaddressbtn = PhotoImage(file = f"pchangeaddressbtn.png")
    ...
    peditprofilebtn = PhotoImage(file = f"peditprofilebtn.png")
    ...
    psignoutbtn = PhotoImage(file = f"psignoutbtn.png")
    ...
    pdeleteaccbtn = PhotoImage(file = f"pdeleteacc.png")
    ...
    phomebtn = PhotoImage(file = f"phomebtn.png")
...
def editprofile():
    ...
    closewindows()
    canvasdefinition()
    editprofilescreenimg = PhotoImage(file = f"editprofilescreen.png")
    ...
    updateprofilebtn= PhotoImage(file = f"updateprofilebtn.png")
...
def changeaddress():
    ...
    closewindows()
    canvasdefinition()
    changeaddressscreenimg = PhotoImage(file = f"changeaddressscreen.png")
    ...
    updateaddressbtn= PhotoImage(file = f"updateaddressbtn.png")
...
def changepassword():
    ...
    closewindows()
    canvasdefinition()
    changepasswordscreenimg = PhotoImage(file = f"changepasswordscreen.png")
    ...
    def showpassword3():
        ...
        hidepwbtn3= PhotoImage(file = f"hidepwsmall.png")
    ...
    #button to show password
    showpwbtn3= PhotoImage(file = f"showpwsmall.png")
    showpw3 = Button(window,image = showpwbtn3,borderwidth=0,highlightthickness = 0,
                     command = showpassword3,
                     relief = "flat",cursor="hand2")
    showpw3.place(x = 763, y = 343,width = 18,height = 18)
    updatepasswordbtn= PhotoImage(file = f"updatepasswordbtn.png")
...
def adminloginscreen(B):
    ...
    canvasdefinition()
    if B==0:
        loginscreenimg = PhotoImage(file = f"adminloginscreenerror.png")
    else:
        loginscreenimg = PhotoImage(file = f"adminloginscreen.png")
    background = canvas.create_image(494.0, 300.0,image=loginscreenimg)
...
def adminoptionsscreen():
    ...
    closewindows()
    canvasdefinition()
    options = PhotoImage(file = f"optionsscreen.png")
    ...
    seecustbtn = PhotoImage(file = f"seecustbtn.png")
    ...
    searchcustbtn = PhotoImage(file = f"searchcustbtn.png")
    ...
    seeprodbtn = PhotoImage(file = f"seeprodbtn.png")
    ...
    searchprodbtn = PhotoImage(file = f"searchprodbtn.png")
...
def searchcustomerrecordsscreen():
    ...
    closewindows()
    canvasdefinition()
    searchcustrecbg = PhotoImage(file = f"searchcustrecscreen.png")
    ...
    searchcustrecbtn = PhotoImage(file = f"searchcustrecbtn.png")
...
def searchproductrecordsscreen():
    ...
    closewindows()
    canvasdefinition()
    searchprodrecbg = PhotoImage(file = f"searchprodrecscreen.png")
    ...
    searchprodrecbtn = PhotoImage(file = f"searchcustrecbtn.png")
...
def prodinfo(i):
    ...
    img = ImageTk.PhotoImage(Image.open("products\{}".format(str(i)+".png")))
